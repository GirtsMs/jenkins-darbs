...
def deploy(String environment, int port){
    ...
    git branch: 'main', poll: false, url: 'https://github.com/mtararujs/python-greetings'
    bat "dir"
    bat "C:/Users/girts/AppData/Roaming/npm/pm2 delete \"greetings-app-${environment}\" || exit 0"
    bat "C:/Users/girts/AppData/Roaming/npm/pm2 start app.py --name \"greetings-app-${environment}\" -- --port ${port}"
}
